#
#  Be sure to run `pod spec lint Drop.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Evgeniy Leychenko"
  # s.authors            = { "Evgeniy Leychenko" => "e.leychenko@theappsolutions.com" }
